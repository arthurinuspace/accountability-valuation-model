...
### 這個公式在 KPI 評估上的優勢：人才分級 (Talent Levels)
这个模型可以让你通过最终得分，精确地界定人才层级：

1.  **👑 Legend (傳奇) > 550分**：重新定義規則，創造巨大資產。
2.  **🚀 Lever (槓桿者) 400-549分**：高基本盤 + 高增值盤，一人抵多人用。
3.  **⭐ Practitioner (實踐者) 280-399分**：守住基本盤，並開始累積資產 (SOP/創新)。
4.  **✅ Competent (稱職) 200-279分**：基本盤穩固，是可靠的執行者，但增值貢獻較少。
5.  **⚠️ Underperformer (需改善) < 200分**：連基本盤都未能守住，需立即改善。
